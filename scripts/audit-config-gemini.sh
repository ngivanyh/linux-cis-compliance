...
#
# CIS Distribution Independent Linux Benchmark v2.0.0 Hardening Script (Systemd Only)
#
# This script applies security configurations based on the provided variables.
# It includes precondition checks, execution of changes, and final verification.
# It also logs all actions to a variable and prints it at the end.
#
...
# Function to log messages to the console, file, and LOG variable
log_message() {
    echo "$1"
    LOG+="$1\n"
}
